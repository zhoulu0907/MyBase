...
-- 2. 默认先连接维护库 pg
-- 3. 会创建 onebase 用户、创建数据库 onebase_ai、并统一授予 public schema 下对象权限
...
GRANT ALL PRIVILEGES ON DATABASE onebase_ai TO onebase;
GRANT CONNECT, TEMPORARY ON DATABASE onebase_ai TO onebase;
