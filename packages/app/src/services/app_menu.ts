...
export const updateApplicationMenuName = (
  params: UpdateApplicationMenuNameReq,
) => {
...
export const updateApplicationMenuOrder = (
  params: UpdateApplicationMenuOrderReq,
) => {
  return appService.post("/menu/update-order", params);
};

export const updateApplicationMenuVisible = (
  params: UpdateApplicationMenuVisibleReq,
) => {
