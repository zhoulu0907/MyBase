...
import { ALL_COMPONENT_TYPES, COMPONENT_MAP, DEFAULT_VALUE_TYPES, ENTITY_COMPONENT_TYPES, FORM_COMPONENT_TYPES, getComponentConfig, getComponentSchema, GridItem, STATUS_OPTIONS, STATUS_VALUES, usePageEditorSignal, WIDTH_OPTIONS, WIDTH_VALUES } from '@onebase/ui-kit';
import './index.css';
...
const LayoutReactSortable: React.FC<LayoutReactSortableProps> = ({
  ...
  useSignals();
  const { mainEntity } = useStoreSignals;
  ...
  const handleSortableSetList = (newList: any[]) => {
        ...
        for (let field of fieldList) {
          ...
          if (cpType === FORM_COMPONENT_TYPES.DATA_SELECT) {
            ...
            schema.config.selectedDataSource = {
              ...
              tableName: field.dataSelectionConfig?.targetEntityName,
        ...
        for (let ele of subFieldList) {
          ...
          if (subType === FORM_COMPONENT_TYPES.DATA_SELECT) {
            ...
            subSchema.config.selectedDataSource = {
              ...
              tableName: ele.dataSelectionConfig?.targetEntityName,
          ...
          subSchema.config.label.display = true;
    ...
    setLayoutSubComponents(id, colComponents);
  };
