...
import { COLLAPSED_OPTIONS, COLLAPSED_VALUES, COMPONENT_GROUP_NAME, LayoutSchema, STATUS_OPTIONS, STATUS_VALUES, usePageEditorSignal } from '@onebase/ui-kit';
import './index.css';

type XCollapseLayoutConfig = typeof LayoutSchema.XCollapseLayoutSchema.config;

const XCollapseLayout = memo((props: XCollapseLayoutConfig & { runtime?: boolean; editPreview?: boolean; useStoreSignals?: any; }) => {
  const { id, label, colCount = 1, status, collapsed, collapseStyle, editPreview, useStoreSignals, runtime = true } = props;
  useSignals();
