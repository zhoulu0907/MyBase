...
const XDatePickerValidate = (props: XInputDatePickerConfig): boolean => {
    // 标题
    ...
    // 可选范围 特定星期
    if (props.dateRange.weekLimit && (!props.dateRange.week || props.dateRange.week.length === 0)) {
        return false;
    }
    // 最早可选日期
...
export default XDatePickerValidate;