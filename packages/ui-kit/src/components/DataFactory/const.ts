...
export const FIELD_TAG_TYPE = {
  TEXT: { VALUE: 'TEXT', LABEL: '文本', COLOR: '#1979FF' },
  LONG_TEXT: { VALUE: 'LONG_TEXT', LABEL: '长文本', COLOR: '#1979FF' },
  EMAIL: { VALUE: 'EMAIL', LABEL: '邮箱', COLOR: '#F53F3F' },
  PHONE: { VALUE: 'PHONE', LABEL: '电话', COLOR: '#1979FF' },
  URL: { VALUE: 'URL', LABEL: '网址', COLOR: '#24B28F' },
  ADDRESS: { VALUE: 'ADDRESS', LABEL: '地址', COLOR: '#7E5AEA' },
  NUMBER: { VALUE: 'NUMBER', LABEL: '数字', COLOR: '#24B28F' },
  DATE: { VALUE: 'DATE', LABEL: '日期', COLOR: '#7E5AEA' },
  DATETIME: { VALUE: 'DATETIME', LABEL: '时间戳', COLOR: '#EBBC00' },
  TIME: { VALUE: 'TIME', LABEL: '时间', COLOR: '#EBBC00' },
  BOOLEAN: { VALUE: 'BOOLEAN', LABEL: '布尔', COLOR: '#EB693A' },
  SELECT: { VALUE: 'SELECT', LABEL: '单选', COLOR: '#008699' },
  MULTI_SELECT: { VALUE: 'MULTI_SELECT', LABEL: '多选', COLOR: '#1979FF' },
  AUTO_CODE: { VALUE: 'AUTO_CODE', LABEL: '自动编码', COLOR: '#008699' },
  USER: { VALUE: 'USER', LABEL: '用户', COLOR: '#24B28F' },
  DEPARTMENT: { VALUE: 'DEPARTMENT', LABEL: '部门', COLOR: '#7E5AEA' },
  ...
  ARRAY: { VALUE: 'ARRAY', LABEL: '数组', COLOR: '#F53F3F' },
