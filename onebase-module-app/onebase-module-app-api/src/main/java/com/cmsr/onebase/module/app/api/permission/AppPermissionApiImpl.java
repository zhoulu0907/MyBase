...
//import com.cmsr.onebase.module.app.core.dal.cache.menu.CachedAppAuthRoleProvider;
...
//
//    @Override
//    public List<MenuDTO> findMenusByApplicationId(Long applicationId) {
//        return null;
//    }
//
//    @Override
//    public List<RoleDTO> findRoles(Long userId, Long applicationId) {
...
//
//    @Override
//    public List<PermissionDTO> findPermissions(Long applicationId, Long roleId, Long menuId) {
