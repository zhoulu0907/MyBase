...
public class AppResourcePageTableDef extends TableDef {
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{PAGESET_ID, PAGE_NAME, PAGE_TYPE, TITLE, LAYOUT, WIDTH, MARGIN, BACKGROUND_COLOR, MAIN_METADATA, ROUTER_PATH, ROUTER_NAME, ROUTER_META_TITLE, TENANT_ID, ID, CREATE_TIME, UPDATE_TIME, CREATOR, UPDATER, DELETED, LOCK_VERSION, EDIT_VIEW_MODE, DETAIL_VIEW_MODE, IS_DEFAULT_EDIT_VIEW_MODE, IS_DEFAULT_DETAIL_VIEW_MODE, IS_LATEST_UPDATED, INTERACTION_RULES};
