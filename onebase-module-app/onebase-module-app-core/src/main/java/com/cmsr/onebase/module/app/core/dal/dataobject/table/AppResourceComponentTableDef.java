 ...
 * @since 2025-12-01
 */
public class AppResourceComponentTableDef extends TableDef {
     ...
     * 
     */
    public static final AppResourceComponentTableDef APP_RESOURCE_COMPONENT = new AppResourceComponentTableDef();
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{ID, COMPONENT_UUID, APPLICATION_ID, VERSION_TAG, PAGE_UUID, COMPONENT_CODE, COMPONENT_INDEX, COMPONENT_TYPE, CONFIG, EDIT_DATA, PARENT_CODE, BLOCK_INDEX, CONTAINER_INDEX, CREATE_TIME, UPDATE_TIME, CREATOR, UPDATER, DELETED, LOCK_VERSION, TENANT_ID};

    public AppResourceComponentTableDef() {
        super("", "app_resource_component");
    }

    private AppResourceComponentTableDef(String schema, String name, String alisa) {
        super(schema, name, alisa);
    }

    public AppResourceComponentTableDef as(String alias) {
        String key = getNameWithSchema() + "." + alias;
        return getCache(key, k -> new AppResourceComponentTableDef("", "app_resource_component", alias));
    }
