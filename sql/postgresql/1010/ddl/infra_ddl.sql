...
-- DROP TABLE public.infra_codegen_column;

CREATE TABLE public.infra_codegen_column (
	id int8 NOT NULL, -- 编号
	table_id int8 NOT NULL, -- 表编号
	column_name varchar(200) NOT NULL, -- 字段名
	data_type varchar(100) NOT NULL, -- 字段类型
	column_comment varchar(500) NOT NULL, -- 字段描述
	"nullable" bool NOT NULL, -- 是否允许为空
	primary_key bool NOT NULL, -- 是否主键
	ordinal_position int4 NOT NULL, -- 排序
	java_type varchar(32) NOT NULL, -- Java 属性类型
	java_field varchar(64) NOT NULL, -- Java 属性名
	dict_type varchar(200) DEFAULT ''::character varying NULL, -- 字典类型
	example varchar(64) DEFAULT NULL::character varying NULL, -- 数据示例
	create_operation bool NOT NULL, -- 是否为 Create 创建操作的字段
	update_operation bool NOT NULL, -- 是否为 Update 更新操作的字段
	list_operation bool NOT NULL, -- 是否为 List 查询操作的字段
	list_operation_condition varchar(32) DEFAULT '='::character varying NOT NULL, -- List 查询操作的条件类型
	list_operation_result bool NOT NULL, -- 是否为 List 查询操作的返回字段
	html_type varchar(32) NOT NULL, -- 显示类型
	creator int8 DEFAULT 0 NULL, -- 创建者
	create_time timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL, -- 创建时间
	updater int8 DEFAULT 0 NULL, -- 更新者
	update_time timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL, -- 更新时间
...
-- DROP TABLE public.infra_codegen_table;

CREATE TABLE public.infra_codegen_table (
	id int8 NOT NULL, -- 编号
	data_source_config_id int8 NOT NULL, -- 数据源配置的编号
	scene int2 DEFAULT 1 NOT NULL, -- 生成场景
	table_name varchar(200) DEFAULT ''::character varying NOT NULL, -- 表名称
	table_comment varchar(500) DEFAULT ''::character varying NOT NULL, -- 表描述
	remark varchar(500) DEFAULT NULL::character varying NULL, -- 备注
	module_name varchar(30) NOT NULL, -- 模块名
	business_name varchar(30) NOT NULL, -- 业务名
	class_name varchar(100) DEFAULT ''::character varying NOT NULL, -- 类名称
	class_comment varchar(50) NOT NULL, -- 类描述
	author varchar(50) NOT NULL, -- 作者
	template_type int2 DEFAULT 1 NOT NULL, -- 模板类型
	front_type int2 NOT NULL, -- 前端类型
	parent_menu_id int8 NULL, -- 父菜单编号
	master_table_id int8 NULL, -- 主表的编号
	sub_join_column_id int8 NULL, -- 子表关联主表的字段编号
	sub_join_many bool NULL, -- 主表与子表是否一对多
	tree_parent_column_id int8 NULL, -- 树表的父字段编号
	tree_name_column_id int8 NULL, -- 树表的名字字段编号
	creator int8 DEFAULT 0 NULL, -- 创建者
	create_time timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL, -- 创建时间
	updater int8 DEFAULT 0 NULL, -- 更新者
	update_time timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL, -- 更新时间
