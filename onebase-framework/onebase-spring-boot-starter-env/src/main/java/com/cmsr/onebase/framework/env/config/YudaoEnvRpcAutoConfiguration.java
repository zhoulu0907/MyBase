package com.cmsr.onebase.framework.env.config;

import com.cmsr.onebase.framework.env.core.fegin.EnvLoadBalancerClientFactory;
import com.cmsr.onebase.framework.env.core.fegin.EnvRequestInterceptor;
