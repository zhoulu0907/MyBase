...
import com.cmsr.onebase.framework.common.tools.core.bean.BeanPath;
...
import com.cmsr.onebase.framework.common.tools.core.lang.TypeReference;
import com.cmsr.onebase.framework.common.tools.core.lang.Validator;
...
import com.cmsr.onebase.framework.common.tools.json.serialize.JSONWriter;
...
public class JSONArray implements JSON, JSONGetter<Integer>, List<Object>, RandomAccess {
    ...
    protected boolean addRaw(Object obj, Filter<Mutable<Object>> filter) {
        ...
        if (ObjUtil.isNull(obj) && ignoreNullValue) {
            return false;
        }
