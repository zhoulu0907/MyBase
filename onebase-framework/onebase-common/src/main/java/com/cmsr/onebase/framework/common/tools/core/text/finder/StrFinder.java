...
package com.cmsr.onebase.framework.common.tools.core.text.finder;
...
public class StrFinder extends TextFinder {
	...
	public StrFinder(final CharSequence strToFind, final boolean caseInsensitive) {
        if (StrUtil.isEmpty(strToFind)) {
            throw new IllegalArgumentException("Text to find must be not null!");
        }
