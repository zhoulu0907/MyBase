...
import com.cmsr.onebase.framework.common.tools.core.annotation.Alias;
...
import com.cmsr.onebase.framework.common.tools.core.collection.UniqueKeySet;
...
import com.cmsr.onebase.framework.common.tools.core.lang.reflect.MethodHandleUtil;
import com.cmsr.onebase.framework.common.tools.core.map.WeakConcurrentMap;
...
public class ReflectUtil {
        ...
        if (null != args) {
            for (int i = 0; i < actualArgs.length; i++) {
                if (i >= args.length || null == args[i]) {
                    ...
                    final Object targetValue = Convert.convert(parameterTypes[i], args[i], true);
                    if (null != targetValue) {
     ...
     * @param field 字段
     * @param value 值，当值类型与字段类型不匹配时，会尝试转换
     * @throws RuntimeException RuntimeException 包装IllegalAccessException异常
     */
     ...
     */
    public static Object getFieldValue(Object obj, Field field) throws RuntimeException {
        if (null == field) {
            return null;
        }
     ...
     * @param args       参数列表
     * @return 执行结果
     * @throws RuntimeException IllegalAccessException等异常包装
     * @see NullWrapperBean
     * @since 3.1.2
     */
    public static <T> T invoke(Object obj, String methodName, Object... args) throws RuntimeException {
        ...
        if (null == method) {
            throw new RuntimeException(StrUtil.format("No such method: [{}] from [{}]", methodName, obj.getClass()));
        }
