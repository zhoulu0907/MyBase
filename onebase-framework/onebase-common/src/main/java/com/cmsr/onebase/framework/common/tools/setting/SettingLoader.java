...
import com.cmsr.onebase.framework.common.tools.core.util.SystemPropsUtil;
...
public class SettingLoader {
    ...
    public SettingLoader(GroupedMap groupedMap) {
        this(groupedMap, StandardCharsets.UTF_8, false);
    }
     ...
     * @return 加载是否成功
     * @throws IORuntimeException 如果资源不存在，抛出此异常
     */
    public boolean load(Resource resource) throws IORuntimeException {
        if (resource == null) {
