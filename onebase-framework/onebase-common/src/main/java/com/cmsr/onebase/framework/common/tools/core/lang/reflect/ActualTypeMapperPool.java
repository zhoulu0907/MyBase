package com.cmsr.onebase.framework.common.tools.core.lang.reflect;
...
public class ActualTypeMapperPool {
	...
	public static Map<String, Type> getStrKeyMap(Type type) {
        Map<Type, Type> origin = get(type);
        Map<String, Type> result = new HashMap<>();
        for (Map.Entry<Type, Type> entry : origin.entrySet()) {
            String keyStr;
            if (entry.getKey() instanceof TypeVariable) {
                keyStr = ((TypeVariable<?>) entry.getKey()).getName();
            } else {
