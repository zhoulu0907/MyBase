...
package com.cmsr.onebase.framework.common.tools.core.io.watch;
...
public class WatchMonitor extends Thread implements Closeable, Serializable {
	 ...
	 *
	 * @param watcher 监听
	 * @throws RuntimeException 监听异常，如果监听关闭抛出此异常
	 */
	public void watch(final Watcher watcher) throws RuntimeException {
...
//		log.debug("Start watching path: [{}]", this.path);
	 ...
	 * </pre>
	 *
	 * @throws RuntimeException 监听异常，IO异常时抛出此异常
	 */
