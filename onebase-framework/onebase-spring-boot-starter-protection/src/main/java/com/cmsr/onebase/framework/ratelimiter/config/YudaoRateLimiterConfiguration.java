package com.cmsr.onebase.framework.ratelimiter.config;

import com.cmsr.onebase.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.cmsr.onebase.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.cmsr.onebase.framework.ratelimiter.core.keyresolver.impl.*;
import com.cmsr.onebase.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
