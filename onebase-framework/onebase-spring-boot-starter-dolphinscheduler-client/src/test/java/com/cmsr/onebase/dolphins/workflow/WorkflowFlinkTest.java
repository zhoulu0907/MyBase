...
public class WorkflowFlinkTest extends BaseTest {
    ...
    public void testCreateFlinkProcessDefinition() {
        ...
        flinkTask.setMainClass("abc.de")
            .setMainJar(new TaskResource().setResourceName("onebase-ds/default/resources/JavaProject.Flink-1.0.0-SNAPSHOT.jar"))
        ...
        TaskDefinition flinkTaskDefinition = TaskDefinitionUtils.createDefaultTaskDefinition(taskCodes.get(0), flinkTask);
    ...
    public void testPage() {
        List<ProcessDefineResp> page = getClient().opsForProcess().page(projectCode, null, null, WORKFLOW_NAME);
