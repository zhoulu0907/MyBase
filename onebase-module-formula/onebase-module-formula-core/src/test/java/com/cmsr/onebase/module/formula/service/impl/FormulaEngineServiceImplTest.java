...
class FormulaEngineServiceImplTest {
    ...
    void testFormulaWithParameters() throws Exception {
        ...
        // 测试参数传递
        Object result = formulaEngineService.executeFormula("FormulaJS.LEFT(text, length)", parameters);
        assertEquals("Hello", result);

        result = formulaEngineService.executeFormula("FormulaJS.SUM(num1, num2)", parameters);
    ...
    void testRealWorldScenarios() throws Exception {
        ...
        Object result = formulaEngineService.executeFormula("FormulaJS.LEFT(userInput, 4)", parameters);
        ...
        result = formulaEngineService.executeFormula("FormulaJS.SUM(price1, price2, price3)", parameters);
        assertEquals(351.5, result);

        // 场景3：格式化用户名
        parameters.put("firstName", "zhang");
        parameters.put("lastName", "san");
        result = formulaEngineService.executeFormula(
