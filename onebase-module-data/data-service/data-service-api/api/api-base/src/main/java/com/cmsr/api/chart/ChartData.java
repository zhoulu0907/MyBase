...
import static com.cmsr.constant.AuthResourceEnum.PANEL;
...
@DeApiPath(value = "/chartDataN", rt = PANEL)
public interface ChartData {

    @Operation(summary = "获取图表数据")
    @PostMapping("getSetData")
    Object getData(@RequestBody ChartViewDTO chartViewDTO) throws Exception;
