...
UPDATE `QRTZ_JOB_DETAILS` SET `JOB_CLASS_NAME` = 'schedule.job.com.cmsr.CheckDsStatusJob' WHERE (`SCHED_NAME` = 'deSyncJob') and (`JOB_NAME` = 'Datasource') and (`JOB_GROUP` = 'check_status');
