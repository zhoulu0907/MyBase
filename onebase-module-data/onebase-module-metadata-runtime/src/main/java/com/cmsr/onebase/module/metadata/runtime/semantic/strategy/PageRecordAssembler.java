...
@Component
public class PageRecordAssembler {
    ...
    public RecordDTO assemble(String entityCode, SemanticPageBodyVO body, Long menuId, String traceId) {
        ...
        return semanticRequestParser.parsePage(entity.getId(), body, menuId, traceId, MethodCodeEnum.GET_PAGE);
    }
}
