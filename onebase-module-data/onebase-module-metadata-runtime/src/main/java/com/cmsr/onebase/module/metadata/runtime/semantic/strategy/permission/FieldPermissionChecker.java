 ...
 */
@Component
public class FieldPermissionChecker implements RuntimePermissionChecker {
     ...
     * 严格模式：存在不可编辑字段时直接抛错
     */
    private void enforceStrictPermission(Map<String, ValueDTO> data, Map<String, Long> nameToId, Set<Long> editableIds) {
     ...
     * 过滤模式：移除不可编辑字段，减少抛错
     */
    private void filterNonEditableFields(Map<String, ValueDTO> data, Map<String, Long> nameToId, Set<Long> editableIds) {
