...
public class ContextInitializer {
    ...
    public ProcessContext initialize(MetadataBusinessEntityDO entityDO, List<MetadataEntityFieldDO> fields, Long menuId, String traceId, com.cmsr.onebase.module.metadata.core.enums.MetadataDataMethodOpEnum op, RecordDTO record) {
