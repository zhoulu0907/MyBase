...
public class EtlCatalogTableDef extends TableDef {
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{ID, APPLICATION_ID, DATASOURCE_UUID, CATALOG_UUID, CATALOG_NAME, DISPLAY_NAME, META_INFO, REMARKS, DECLARATION, DELETED, CREATOR, CREATE_TIME, UPDATER, UPDATE_TIME, LOCK_VERSION, TENANT_ID};
