...
public class EtlTableTableDef extends TableDef {
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{ID, APPLICATION_ID, TABLE_UUID, DATASOURCE_UUID, CATALOG_UUID, SCHEMA_UUID, TABLE_NAME, TABLE_TYPE, DISPLAY_NAME, META_INFO, REMARKS, DECLARATION, DELETED, CREATOR, CREATE_TIME, UPDATER, UPDATE_TIME, LOCK_VERSION, TENANT_ID};
