...
public class EtlDatasourceTableDef extends TableDef {
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{ID, APPLICATION_ID, DATASOURCE_UUID, DATASOURCE_NAME, DATASOURCE_TYPE, CONFIG, COLLECT_STATUS, COLLECT_START_TIME, COLLECT_END_TIME, READONLY, DELETED, CREATOR, CREATE_TIME, UPDATER, UPDATE_TIME, LOCK_VERSION, TENANT_ID, DECLARATION};
