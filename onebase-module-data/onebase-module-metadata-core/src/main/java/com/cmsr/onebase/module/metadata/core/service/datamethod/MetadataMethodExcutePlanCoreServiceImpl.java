...
import com.cmsr.onebase.module.metadata.core.dal.database.MetadataMethodExcutePlanRepository;
...
@Service
@Slf4j
public class MetadataMethodExcutePlanCoreServiceImpl implements MetadataMethodExcutePlanCoreService {
    ...
    public MetadataMethodExcutePlanDO getEnabledByMethodCode(String methodCode) {
        try {
            ...
            MetadataDataSystemMethodDO method =
