...
public class SemanticOperatorConditionApplier {
    public void apply(ConfigStore configs, String fieldName, String operator, Object value) {
        ...
        switch (opEnum) {
            case EQUALS:
                configs.and(Compare.EQUAL, fieldName, value);
                break;
            case NOT_EQUALS:
                configs.and(Compare.NOT_EQUAL, fieldName, value);
                break;
            case GREATER_THAN:
                configs.and(Compare.GREAT, fieldName, value);
                break;
            case GREATER_EQUALS:
                configs.and(Compare.GREAT_EQUAL, fieldName, value);
                break;
            case LESS_THAN:
                configs.and(Compare.LESS, fieldName, value);
                break;
            case LESS_EQUALS:
                configs.and(Compare.LESS_EQUAL, fieldName, value);
                break;
            case CONTAINS:
                configs.and(Compare.LIKE, fieldName, value);
                break;
            case NOT_CONTAINS:
                configs.and(Compare.NOT_LIKE, fieldName, value);
                break;
            case EARLIER_THAN:
                configs.and(Compare.LESS, fieldName, value);
                break;
            case LATER_THAN:
                ...
                break;
            case EXISTS_IN:
                configs.and(Compare.IN, fieldName, value);
                break;
            case NOT_EXISTS_IN:
                configs.and(Compare.NOT_IN, fieldName, value);
                break;
            case RANGE:
                ...
                break;
            case IS_EMPTY:
                configs.and(Compare.EQUAL, fieldName, "");
                break;
            case IS_NOT_EMPTY:
                configs.and(Compare.NOT_EQUAL, fieldName, "");
                break;
            default:
                configs.and(Compare.LIKE, fieldName, value);
                break;
