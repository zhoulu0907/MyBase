 ...
 */
public class DataMethodApiUtils {
     ...
     */
    public static EntityFieldDataReqDTO convert(Map<String, Object> data) {
        ...
        // 处理过滤条件
        List<List<ConditionDTO>> conditionDTOList = processFilterCondition(data);
     ...
     * @return 转换后的条件DTO列表
     */
    private static List<List<ConditionDTO>> processFilterCondition(Map<String, Object> data) {
        ...
        for (Map<String, Object> outerCondition : filterCondition) {
            ...
            if (innerConditions != null && !innerConditions.isEmpty()) {
                ...
                for (Map<String, Object> innerCondition : innerConditions) {
                    ...
                    // 设置字段值 TODO operatorType 没处理，value 要明确
