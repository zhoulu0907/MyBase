...
public class FlowProcessFormTableDef extends TableDef {
     ...
     * 
     */
    public static final FlowProcessFormTableDef FLOW_PROCESS_FORM = new FlowProcessFormTableDef();
    ...
    private FlowProcessFormTableDef(String schema, String name, String alisa) {
        super(schema, name, alisa);
    }

    public FlowProcessFormTableDef as(String alias) {
        String key = getNameWithSchema() + "." + alias;
        return getCache(key, k -> new FlowProcessFormTableDef("", "flow_process_form", alias));
    }
