...
public class FlowJobDateFieldHandler implements MessageListener, ApplicationRunner, DisposableBean {
    ...
    private String topic = RocketMQConstants.JOB_EVENTS_TOPIC_FLD;
