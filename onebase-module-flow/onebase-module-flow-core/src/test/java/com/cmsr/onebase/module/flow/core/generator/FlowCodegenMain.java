package com.cmsr.onebase.module.flow.core.generator;
...
public class FlowCodegenMain {
    ...
    private static String basePackage = "com.cmsr.onebase.module.flow.core.dal";
