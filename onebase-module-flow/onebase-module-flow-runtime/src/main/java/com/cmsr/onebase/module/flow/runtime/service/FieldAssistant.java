...
import com.cmsr.onebase.framework.common.tools.JdbcTypeConvertor;
import com.cmsr.onebase.module.flow.core.rule.ConditionItem;
import com.cmsr.onebase.module.flow.core.rule.RuleItem;
...
public class FieldAssistant {
     ...
     * 然后根据下面的方法转换成具体的类型
     * com.cmsr.onebase.framework.common.tools.JdbcTypeConvertor#convert(String, java.lang.Object)
     *
     * @param inputParams
     * @return
     */
