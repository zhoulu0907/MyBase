...
//删除应用授权企业
export const removeCorpAppApi = (id: string) => systemService.post(`/corp-app-relation/delete?id=${id}`);
...
//获取应用列表
export const getCorpAppSimpleListApi = (id: string) =>
  systemService.post(`/corp-app-relation/corp-no-relation-app-list?corpId=${id}`);
