...
public class AppResourcePagesetTableDef extends TableDef {
    ...
    public final QueryColumn DATA_TITLE = new QueryColumn(this, "data_title");
     ...
     * 绑定的数据大屏id
     */
    public final QueryColumn DASHBOARD_ID = new QueryColumn(this, "dashboard_id");
    ...
    public final QueryColumn REDIRECT_TYPE = new QueryColumn(this, "redirect_type");


    public final QueryColumn APPLICATION_ID = new QueryColumn(this, "application_id");


    public final QueryColumn DATA_TITLE_TYPE = new QueryColumn(this, "data_title_type");
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{ID, PAGESET_UUID, APPLICATION_ID, VERSION_TAG, MENU_UUID, PAGESET_CODE, PAGESET_TYPE, MAIN_METADATA, PAGESET_NAME, DISPLAY_NAME, DESCRIPTION, TENANT_ID, CREATE_TIME, UPDATE_TIME, CREATOR, UPDATER, DELETED, LOCK_VERSION, DASHBOARD_ID, DATA_TITLE_TYPE, DATA_TITLE, REDIRECT_TYPE};
