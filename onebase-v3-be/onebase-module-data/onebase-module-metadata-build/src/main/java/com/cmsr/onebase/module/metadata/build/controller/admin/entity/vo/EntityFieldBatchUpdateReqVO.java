...
/**
 * 管理后台 - 批量更新实体字段 Request VO
 *
 * @author bty418
 * @date 2025-01-25
 */
@Schema(description = "管理后台 - 批量更新实体字段 Request VO")
@Data
public class EntityFieldBatchUpdateReqVO {
    ...
    @Valid
    private List<EntityFieldUpdateItemVO> fields;
