...
public class EtlWorkflowTableDef extends TableDef {
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{ID, APPLICATION_ID, WORKFLOW_UUID, WORKFLOW_NAME, CONFIG, IS_ENABLED, SCHEDULE_STRATEGY, SCHEDULE_CONFIG, DELETED, CREATOR, CREATE_TIME, UPDATER, UPDATE_TIME, LOCK_VERSION, TENANT_ID, DECLARATION};
