...
@Data
@NodeType("switchCase")
public class SwitchCaseNodeData extends NodeData implements FieldTypeProcessable, Serializable {
    ...
    public void processFieldTypes(Map<String, Map<String, SemanticFieldSchemaDTO>> fieldInfoMap) {
        FieldTypeHelper.processConditionList( getFilterCondition(), fieldInfoMap, 3);
    }
