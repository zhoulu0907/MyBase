...
import com.cmsr.onebase.module.system.api.social.dto.*;
...
public interface SocialClientApi {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirectUri", description = "重定向 URL", example = "http://cmsr.com", required = true)
    })
    ...
    @Parameters({
            @Parameter(name = "userType", description = "用户类型", example = "1", required = true),
            @Parameter(name = "url", description = "访问 URL", example = "http://cmsr.com", required = true)
    })
