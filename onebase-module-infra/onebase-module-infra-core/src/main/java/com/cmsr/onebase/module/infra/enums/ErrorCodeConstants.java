...
public interface ErrorCodeConstants {
    ...
    // ========== 防暴力破解相关 1-001-005-100 ==========
    ErrorCode ACCOUNT_LOCKED = new ErrorCode(1_001_005_100, "账号已被锁定，请{}后再试");
    ErrorCode LOGIN_FAILED_REMAINING_ATTEMPTS = new ErrorCode(1_001_005_101, "用户名或密码错误，还剩{}次尝试机会");
