...
import com.cmsr.onebase.module.infra.controller.admin.codegen.vo.column.CodegenColumnSaveReqVO;
...
import static com.cmsr.onebase.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.cmsr.onebase.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.cmsr.onebase.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.cmsr.onebase.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.cmsr.onebase.framework.test.core.util.AssertUtils.assertServiceException;
import static com.cmsr.onebase.framework.test.core.util.RandomUtils.*;
...
public class CodegenServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateCodegenList() {
        ...
        when(tableInfo.getComment()).thenReturn("开发者");
    ...
    public void testGetDatabaseTableList() {
        ...
        assertEquals("开发者", result.get(0).getComment());
    }
