package com.cmsr.onebase.module.infra.controller.admin.codegen.vo.table;
...
public class CodegenTableRespVO {
    ...
    @Schema(description = "表描述", requiredMode = Schema.RequiredMode.REQUIRED, example = "onebase")
    ...
    @Schema(description = "作者", requiredMode = Schema.RequiredMode.REQUIRED, example = "用户")
