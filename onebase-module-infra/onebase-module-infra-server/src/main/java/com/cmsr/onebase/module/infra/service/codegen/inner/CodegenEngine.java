package com.cmsr.onebase.module.infra.service.codegen.inner;
...
import com.cmsr.onebase.module.infra.enums.codegen.CodegenVOTypeEnum;
...
public class CodegenEngine {
     ...
     *
     * true  - 需要有 onebase-module-xxx-api 模块
    ...
    public CodegenEngine() {
        ...
        this.cloudEnable = ClassUtils.isPresent("com.cmsr.onebase.module.infra.framework.rpc.config.RpcConfiguration",
    ...
    private Map<String, String> getTemplates(Integer frontType) {
        ...
        if (Boolean.FALSE.equals(cloudEnable)) {
            SERVER_TEMPLATES.forEach((templatePath, filePath) -> {
                filePath = StrUtil.replace(filePath, "/onebase-module-${table.moduleName}-api", "");
                filePath = StrUtil.replace(filePath, "/onebase-module-${table.moduleName}-server", "");
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "onebase-module-${table.moduleName}/" + // 顶级模块
                "onebase-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "onebase-module-${table.moduleName}/" + // 顶级模块
                "onebase-module-${table.moduleName}-server/" + // 子模块
