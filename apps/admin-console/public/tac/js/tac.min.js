                ...
                return r && t
                  ? t.split(",").map(function (t) {
                      ...
                      return i(
                        e.replace(
                          a,
                          "".concat(t.replace(/{fileName}/g, r), ".css"),
                        ),
                      );
                    })
                  : [e.replace(".js", ".css")];
      ...
      600: (t, e, a) => {
        ...
        function c(t) {
          ...
          (currentCaptcha.currentCaptchaData.trackArr.push({
            ...
            window.currentCaptcha.doDown &&
              window.currentCaptcha.doDown(t, window.currentCaptcha));
        }
        function s(t) {
          ...
          (h.push(u),
            ...
            window.currentCaptcha.doMove &&
              window.currentCaptcha.doMove(t, currentCaptcha));
        }
        function o() {
        ...
        function d(t) {
          ...
          (d.push(h),
            window.currentCaptcha.doUp &&
              window.currentCaptcha.doUp(t, window.currentCaptcha),
            window.currentCaptcha.endCallback(
        ...
        function l(t, e) {
          (A(t)
            .find("#tianai-captcha-tips")
            .removeClass("tianai-captcha-tips-on"),
            e && setTimeout(e, 0.35));
        }
        function p(t, e, a, i) {
        ...
        class g {
          ...
          css(t, e) {
            if ("string" == typeof t && "string" == typeof e)
              ...
              for (var a in t)
                t.hasOwnProperty(a) && (this.getTarget().style[a] = t[a]);
          ...
          append(t) {
            if ("string" == typeof t)
              this.getTarget().insertAdjacentHTML("beforeend", t);
            else {
        ...
        class b {
          constructor(t) {
            ...
            if (!t.requestCaptchaDataUrl)
              throw new Error(
                "[TAC] 必须配置 [requestCaptchaDataUrl]请求验证码接口",
              );
              ...
              this.insertRequestChain(0, {
                preRequest(t, e, a, i) {
                  if (this.timeToTimestamp && e.data)
                    for (let t in e.data)
                      e.data[t] instanceof Date &&
                        (e.data[t] = e.data[t].getTime());
                  return !0;
                },
              }));
          }
              ...
              ((i.onreadystatechange = function () {
                if (i.readyState === XMLHttpRequest.DONE)
                  if (i.status >= 200 && i.status <= 500) {
                    ...
                    a(new Error("Request failed with status: " + i.status));
              }),
                (i.onerror = function () {
            ...
            return this.doSendRequest(n)
              ...
              .then((t) => {
                if (200 == t.code) {
                  ...
                  a.showTips(`验证成功,耗时${r}秒`, 1, () =>
                    this.validSuccess(t, a, i),
                  );
                } else {
                  let e = "验证失败，请重新尝试!";
        ...
        ((window.TAC = class {
          ...
          init() {
            return (
              ...
              (this.domTemplate = this.config.domBindEl.find(
            ...
            this.config.requestCaptchaData().then((t) => {
              ...
              (e.init(t, (t, e) => {
                ...
                ((e.currentCaptchaData = void 0),
                  this.config.validCaptcha(r, i, e, this));
              }),
                this.openCaptcha());
            });
          }
        ...
        if (void 0 !== n)
          for (
            ...
            if (
              ...
              l.getAttribute("data-webpack") == e + n
            ) {
              s = l;
              break;
            }
        ...
        var t = (t, e, a, i, r) => {
          ...
          e = (t, e) => {
            for (
              ...
              var r =
                (c = a[i]).getAttribute("data-href") || c.getAttribute("href");
              if ("stylesheet" === c.rel && (r === t || r === e)) return c;
            }
            var n = document.getElementsByTagName("style");
            for (i = 0; i < n.length; i++) {
              var c;
              if ((r = (c = n[i]).getAttribute("data-href")) === t || r === e)
                return c;
            }
          },
          a = [],
          ...
          for (
            ...
            if (d && (!d.hot._selfAccepted || d.hot._selfInvalidated)) {
              if (d.hot._selfDeclined)
                return { type: "self-declined", chain: s, moduleId: c };
              if (d.hot._main)
                return { type: "unaccepted", chain: s, moduleId: c };
            ...
            switch (
              ...
              case "self-declined":
                (t.onDeclined && t.onDeclined(A),
                  t.ignoreDeclined ||
                    (f = new Error(
                      "Aborted because of self decline: " + A.moduleId + C,
                    )));
                break;
              case "declined":
                (t.onDeclined && t.onDeclined(A),
              ...
              case "unaccepted":
                (t.onUnaccepted && t.onUnaccepted(A),
                  t.ignoreUnaccepted ||
                    (f = new Error(
                      "Aborted because " + u + " is not accepted" + C,
                    )));
                break;
              case "accepted":
