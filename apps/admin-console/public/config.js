window.global_config = {
  ...
  // RESOURCE_URL: 'http://s25029301301.dev.internal.virtueit.net:81/v1-snapshot/onebaseserver/platform/infra/file/download',

  BASE_URL: 'http://localhost:48080/admin-api',
  PLATFORM_BASE_URL: 'http://localhost:48080/platform',
  RESOURCE_URL: 'http://localhost:48080/platform/infra/file/download',
