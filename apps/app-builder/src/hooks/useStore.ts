...
export function usePageEditorStore(){
    ...
    return { curComponentID, setCurComponentID, clearCurComponentID, curComponentSchema, setCurComponentSchema, showDeleteButton, setShowDeleteButton,
        components, setComponents, delComponents, clearComponents,
        pageComponentSchemas, setPageComponentSchemas, delPageComponentSchemas, clearPageComponentSchemas,
        colComponentsMap, setColComponentsMap, delColComponentsMap, clearColComponentsMap,
    };
}