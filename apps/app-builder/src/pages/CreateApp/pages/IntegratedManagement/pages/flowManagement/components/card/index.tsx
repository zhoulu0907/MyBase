...
import { ProcessDefinition, ProcessStatus, type FlowMgmt } from '@onebase/app';
...
const FlowCard: React.FC<FlowCardProps> = ({ data, handleEdit, handleDelete }) => {
    ...
    <div className={styles.card}>
      ...
      <div className={styles.cardFooter}>
        <div className={styles.cardFooterLeft}>
          <Switch checked={data.processStatus === ProcessStatus.ENABLED} />
        </div>
