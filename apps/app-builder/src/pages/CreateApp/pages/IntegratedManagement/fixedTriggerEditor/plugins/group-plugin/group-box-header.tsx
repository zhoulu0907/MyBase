...
import { type IGroupBoxHeader } from '@flowgram.ai/group-plugin';
...
export const GroupBoxHeader: IGroupBoxHeader = (props: any) => {
  ...
  return (
    <div className="gedit-group-container" style={basicStyle}>
      ...
      />
      <GroupTools groupNode={groupNode} groupController={groupController} visible={groupController.hovered} />
    </div>
  );
};
