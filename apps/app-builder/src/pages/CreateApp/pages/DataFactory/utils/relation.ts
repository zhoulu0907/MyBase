...
export const DEFINE_RELATIONSHIP_TYPE_LIST = [
  'DEFINE_ONE_TO_ONE',
  'DEFINE_ONE_TO_MANY',
  'DEFINE_MANY_TO_ONE',
  'DEFINE_MANY_TO_MANY',
  'SUBTABLE_ONE_TO_MANY'
];

export const ALL_RELATIONSHIP_TYPE_LIST = DEFINE_RELATIONSHIP_TYPE_LIST.concat(['DATA_SELECT', 'DATA_SELECT_MULTI']);

export const RELATIONSHIP_TYPE = Object.fromEntries(ALL_RELATIONSHIP_TYPE_LIST.map((type) => [type, type])) as Record<
  string,
  string
>;
