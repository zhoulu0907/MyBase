...
import TiangongAppCard from './components/AppCard/tiangong';
...
const TiangongApplicationPage: React.FC = () => {
  const {
    form,
    navigate,
    pageSize,
  ...
  return (
    <div className={styles.appPage}>
      <div className={styles.welcomeText}>欢迎使用天工使能平台，四种方式极速创建专属应用！</div>
      <div className={styles.appContainer}>
        <div className={styles.appHasDataBox}>
          {ACTIONS.CREATE && (
            <div className={styles.appCreate}>
              <div>
...
export default TiangongApplicationPage;
