import { Checkbox, Input, Message, Modal, Pagination, Spin, Table } from '@arco-design/web-react';
...
const UserSelectModal: React.FC<UserSelectModalProps> = ({ visible, onCancel, onOk, currentRoleUsers }) => {
  ...
  const columns = useMemo(
    ...
    [selectedUserIds, userList, currentPageSelectedUserIds, handleUserSelect, handleSelectAll, currentRoleUsers]
  );
