            ...
            content={
              <div style={{ width: 264 }}>
                <div style={{ display: 'flex', marginBottom: 16 }}>
                  <span style={{ width: 80, color: 'var(--color-text-3)' }}>手机号</span>
                  <span>{tag.adminMobile || '-'}</span>
                </div>
                <div style={{ display: 'flex', marginBottom: 16 }}>
                  <span style={{ width: 80, color: 'var(--color-text-3)' }}>邮箱</span>
                  <span>{tag.adminEmail || '-'}</span>
                </div>
                <div style={{ display: 'flex' }}>
                  <span style={{ width: 80, color: 'var(--color-text-3)' }}>所属部门</span>
