...
export const AuthorizedApp: React.FC<IAuthorizedAppProps> = ({
  ...
  return (
    <>
      <div className={className || styles.authorizedApp}>
        <TopHeader title="添加应用" onAdd={handleAddApplication} isBusiness={false} setSearchInputValue={onSearch} />
        <CommonTable
          loading={loading}
          data={tableData}
          columns={columns}
      ...
      <EditAuthorizedTime
        ...
        onUpdateData={handleSubmitTime}
        initialFormData={authorizedAppItem}
      />
      {/* 创建授权应用modal */}
      <CreateAppModal
        ...
        tableData={tableData}
        onCloseAppModal={handleCloseModal}
        onSaveAppData={handleAddSubmit}
      />
    </>
  );
};
