import { Button, Grid, Result, Space, Typography } from '@arco-design/web-react';
...
export const CreateSuccess: React.FC<ICreateSuccessProps> = ({
  successData,
  setCurrentStep,
  ...
  //创建企业的第四步的返回button
  const handleGoBack = () => {
    navigate(`/onebase/${tenantId}/setting/enterprise`);
  };
      ...
      extra={[
        <Space direction="vertical" className={styles.notification}>
          <Row className={styles.section}>
            ...
            <Col span={19}>
              <Typography>{successData?.mobile || ''}</Typography>
            </Col>
          </Row>
          <Row className={styles.section}>
            <Col span={5}>
            ...
            <Col span={19}>
              <Typography.Paragraph copyable className={styles.link}>
