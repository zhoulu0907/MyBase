...
export const getMenuConfig = (tenantId?: string): MenuItemType[] => [
  {
    key: 'application',
    title: '应用管理',
...
export const platMenuData = (menuConfig: MenuItemType[]): MenuItemType[] => {
...
export const findSelectedKeys = (items: MenuItemType[], path: string): string[] => {
...
export const findPathByKey = (items: MenuItemType[], targetKey: string): string | null => {
  for (const item of items) {
...
export const handleMenuClick = async (key: string, finalMenuItems: MenuItemType[], navigate: ReturnType<typeof useNavigate>) => {
