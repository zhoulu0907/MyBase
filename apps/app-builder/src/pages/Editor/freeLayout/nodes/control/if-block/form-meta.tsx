import { type FormMeta, type FormRenderProps, Field } from '@flowgram.ai/free-layout-editor';
  ...
  return (
    <div
      style={{
        ...
        height: '100%',
        border: '1px solid',
        borderColor: node.index === 0 ? '#00B42A' : '#F53F3F',
        backgroundColor: '#fff',
        padding: '4px 8px',
        borderRadius: 16,
        color: '#272E3B',
    ...
    >
      <div
        style={{
          width: 16,
          height: 16,
          backgroundColor: node.index === 0 ? '#E8FFEA' : '#FFECE8',
          color: node.index === 0 ? '#00B42A' : '#F53F3F',
          textAlign: 'center',
          lineHeight: '16px',
          borderRadius: 8,
          fontWeight: 500,
