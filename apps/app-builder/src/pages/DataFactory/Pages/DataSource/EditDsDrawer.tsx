...
import type { DatasourceSaveReqVO, DatasourceTestConnectionReqVO, DatasourceRespVO } from '@/types/api';
...
const EditDsDrawer: React.FC<EditDsDrawerProps> = ({ 
  ...
  const handleTest = async () => {
    ...
    //   if (res.code === 0) {
    //     if (res.data.success) {
    //       Message.success(`连接成功，耗时 ${res.data.duration}ms`);
    //     } else {
