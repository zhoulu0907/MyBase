...
import { testDatasourceConnection, createDatasource } from '@onebase/app/src/services/dataresource';
    ...
    <>
      ...
      >
        <Form.Item
          ...
          rules={rules.code}
        >
          <Input maxLength={200} placeholder="请输入数据源编码，由字母、数字、下划线组合，须以字母开头，不超过40个字符" />
        </Form.Item>
        <Form.Item
          label="数据源名称"
