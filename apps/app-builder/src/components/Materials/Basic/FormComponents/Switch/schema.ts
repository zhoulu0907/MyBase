import { baseConfig, baseDefault, layoutConfig, statusConfig, /* widthConfig, */ type ICommonBaseType, type TStatusSelectKeyType, type TWidthSelectKeyType, type TLayoutSelectKeyType } from "@/components/Materials/common";
