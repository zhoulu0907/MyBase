...
export type TWidthSelectKeyType =
  (typeof WIDTH_VALUES)[keyof typeof WIDTH_VALUES];
...
export type TStatusSelectKeyType =
...
export type TAlignSelectKeyType =
  (typeof ALIGN_VALUES)[keyof typeof ALIGN_VALUES];
...
export type TDateTypeSelectKeyType =
  (typeof DATE_VALUES)[keyof typeof DATE_VALUES];
...
export type TLayoutSelectKeyType =
  (typeof LAYOUT_VALUES)[keyof typeof LAYOUT_VALUES];
...
// 文件列表
export type TUploadSelectKeyType =
  (typeof UPLOAD_VALUES)[keyof typeof UPLOAD_VALUES];
...
export type TPagePositionSelectKeyType =
  (typeof PAGINATION_POSITION_VALUES)[keyof typeof PAGINATION_POSITION_VALUES];
