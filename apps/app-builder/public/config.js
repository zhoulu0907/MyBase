window.global_config = {
  ...
  // RESOURCE_URL: 'http://s25029301301.dev.internal.virtueit.net:81/v1-snapshot/onebaseserver/admin-api/infra/file/download',

  BASE_URL: 'http://localhost:48080/admin-api',
  PLATFORM_BASE_URL: 'http://localhost:48080/platform',
  RUNTIME_BASE_URL: 'http://localhost:48080/runtime',
  RESOURCE_URL: 'http://localhost:48080/admin-api/infra/file/download',
