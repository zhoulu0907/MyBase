...
public class MailTemplateController {
    ...
    @PreAuthorize("@ss.hasPermission('tenant:mail-template:create')")
    ...
    @PreAuthorize("@ss.hasPermission('tenant:mail-template:update')")
    ...
    @PreAuthorize("@ss.hasPermission('tenant:mail-template:delete')")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @PreAuthorize("@ss.hasPermission('tenant:mail-template:query')")
    ...
    @PreAuthorize("@ss.hasPermission('tenant:mail-template:send-mail')")
