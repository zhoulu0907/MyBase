...
public class ApplicationAuthEnterpriseController   {
    ...
    public CommonResult<Boolean> createApplicationAuthEnterprise(@Valid @RequestBody ApplicationAuthEnterpriseInertReqVO createReqVO) {
    ...
    public CommonResult<Boolean> updateApplicationAuthEnterprise(@Valid @RequestBody ApplicationAuthEnterpriseInertReqVO updateReqVO) {
