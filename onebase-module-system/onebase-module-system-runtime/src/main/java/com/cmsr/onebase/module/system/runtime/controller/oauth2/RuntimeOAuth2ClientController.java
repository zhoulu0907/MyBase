...
import com.cmsr.onebase.module.system.vo.oauth.OAuth2ClientRespVO;
...
@Validated
public class RuntimeOAuth2ClientController {
...
//    @PreAuthorize("@ss.hasPermission('tenant:oauth2-client:create')")
    ...
    @PreAuthorize("@ss.hasPermission('tenant:oauth2-client:update')")
    ...
    @PreAuthorize("@ss.hasPermission('tenant:oauth2-client:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('tenant:oauth2-client:query')")
