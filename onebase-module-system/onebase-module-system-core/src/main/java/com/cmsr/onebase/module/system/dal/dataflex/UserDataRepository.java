// package com.cmsr.onebase.module.system.dal.dataflex;
//
...
// import com.cmsr.onebase.module.system.dal.mapper.UserDataMapper;
...
// @Slf4j
// @Repository
// public class UserDataRepository extends ServiceImpl<UserDataMapper, AdminUserDO> {
//
//     /**
...
//         return list(query().isNull(AdminUserDO.DEPT_ID));
//     }
//
//
//     public List<AdminUserDO> findUserByUserType(Integer userType) {
//         return list(query()
//                 .isNull(AdminUserDO.DEPT_ID)
...
//         return list(query().like(AdminUserDO.NICKNAME, nickname)
//                 .eq(AdminUserDO.USER_TYPE, userType, userType != null));
//     }
//
//     /**
...
//         QueryWrapper queryWrapper = query().like(AdminUserDO.NICKNAME, reqVO.getNickname(), StringUtils.isNotBlank(reqVO.getNickname()))
...
//                 .in(AdminUserDO.DEPT_ID, deptIds, deptIds != null && !deptIds.isEmpty())
...
//                 queryWrapper.ge(BaseDO.CREATE_TIME, reqVO.getCreateTime()[0]);
//             }
//             if (reqVO.getCreateTime()[1] != null) {
//                 queryWrapper.le(BaseDO.CREATE_TIME, reqVO.getCreateTime()[1]);
//             }
//         }
//         // 根据关键词模糊查询
...
//                             .or(new Consumer<QueryWrapper>() {
//                                 @Override
//                                 public void accept(QueryWrapper query) {
//                                     query.like(AdminUserDO.USERNAME, reqVO.getKeyword());
//                                 }
//                             }));
//                             // .or(queryWrapper1 -> queryWrapper1.like(AdminUserDO.USERNAME, reqVO.getKeyword()))
//
//
...
//         }
//         page(Page.of(reqVO.getPageNo(), reqVO.getPageSize()), queryWrapper);
//
//         DefaultConfigStore configStore = buildUserConfigStore();
//         // 根据关键词模糊查询
//         if (reqVO.getKeyword() != null && !reqVO.getKeyword().trim().isEmpty()) {
