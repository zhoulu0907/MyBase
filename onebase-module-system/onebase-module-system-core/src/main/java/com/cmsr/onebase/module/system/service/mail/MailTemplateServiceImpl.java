...
import com.cmsr.onebase.module.system.vo.mail.MailTemplatePageReqVO;
import com.cmsr.onebase.module.system.vo.mail.MailTemplateSaveReqVO;
import com.cmsr.onebase.module.system.dal.database.MailTemplateDataRepository;
...
public class MailTemplateServiceImpl implements MailTemplateService {
    ...
    @Resource
    private MailTemplateDataRepository mailTemplateDataRepository;
    ...
    public Long createMailTemplate(MailTemplateSaveReqVO createReqVO) {
        ...
        mailTemplateDataRepository.insert(template);
    ...
    public void updateMailTemplate(@Valid MailTemplateSaveReqVO updateReqVO) {
        ...
        mailTemplateDataRepository.update(updateObj);
    }

    @VisibleForTesting
    @TenantIgnore
    void validateCodeUnique(Long id, String code) {
        MailTemplateDO template = mailTemplateDataRepository.findOneByCode(code);
        if (template == null) {
            return;
        }
        // 存在 template 记录的情况下
    ...
    public void deleteMailTemplate(Long id) {
        ...
        // 删除
        mailTemplateDataRepository.deleteById(id);
    }

    private void validateMailTemplateExists(Long id) {
        if (mailTemplateDataRepository.findById(id) == null) {
    ...
    public MailTemplateDO getMailTemplate(Long id) {
        return mailTemplateDataRepository.findById(id);
    }
    ...
    public MailTemplateDO getMailTemplateByCodeFromCache(String code) {
        return mailTemplateDataRepository.findOneByCode(code);
    }

    @Override
    @TenantIgnore
    public PageResult<MailTemplateDO> getMailTemplatePage(MailTemplatePageReqVO pageReqVO) {
        return mailTemplateDataRepository.findPage(pageReqVO);
    }

    @Override
    @TenantIgnore
    public List<MailTemplateDO> getMailTemplateList() {
        return mailTemplateDataRepository.findAll();
    }
    ...
    public long getMailTemplateCountByAccountId(Long accountId) {
        return mailTemplateDataRepository.countByAccountId(accountId);
    }
