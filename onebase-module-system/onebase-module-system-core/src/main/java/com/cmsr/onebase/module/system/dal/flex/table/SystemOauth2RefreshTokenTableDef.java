...
public class SystemOauth2RefreshTokenTableDef extends TableDef {
     ...
     * OAuth2 刷新令牌
     */
    public static final SystemOauth2RefreshTokenTableDef SYSTEM_OAUTH2_REFRESH_TOKEN = new SystemOauth2RefreshTokenTableDef();
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{ID, USER_ID, REFRESH_TOKEN, USER_TYPE, CLIENT_ID, SCOPES, EXPIRES_TIME, CREATOR, CREATE_TIME, UPDATER, UPDATE_TIME, DELETED, TENANT_ID, CORP_ID, APP_ID, RUN_MODE};

    public SystemOauth2RefreshTokenTableDef() {
        super("", "system_oauth2_refresh_token");
    }

    private SystemOauth2RefreshTokenTableDef(String schema, String name, String alisa) {
        super(schema, name, alisa);
    }

    public SystemOauth2RefreshTokenTableDef as(String alias) {
        String key = getNameWithSchema() + "." + alias;
        return getCache(key, k -> new SystemOauth2RefreshTokenTableDef("", "system_oauth2_refresh_token", alias));
    }
