...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.cmsr.onebase";
    private static final String ARTIFACT_ID = "onebase";
    private static final String PACKAGE_NAME = "com.cmsr.onebase";
    private static final String TITLE = "OneBase管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.cmsr.onebase";
        String artifactIdNew = "onebase";
        String packageNameNew = "com.cmsr.onebase";
        String titleNew = "OneBase管理系统";
        String projectBaseDirNew =  "D:\\ob-new"; // 一键改名后，“新”项目所在的目录
