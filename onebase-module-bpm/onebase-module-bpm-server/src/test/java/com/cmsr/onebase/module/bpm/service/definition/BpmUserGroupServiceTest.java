...
import com.cmsr.onebase.framework.test.core.util.AssertUtils;
import com.cmsr.onebase.framework.test.core.util.RandomUtils;
import com.cmsr.onebase.module.bpm.controller.admin.definition.vo.group.BpmUserGroupSaveReqVO;
...
import com.cmsr.onebase.module.bpm.dal.mysql.definition.BpmUserGroupMapper;
...
import static com.cmsr.onebase.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       // 测试 name 不匹配
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("用户")));
       // 测试 status 不匹配
