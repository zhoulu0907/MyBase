...
import com.cmsr.onebase.framework.common.util.number.NumberUtils;
...
import com.cmsr.onebase.module.bpm.controller.admin.task.vo.task.*;
import com.cmsr.onebase.module.bpm.convert.task.BpmTaskConvert;
...
import com.cmsr.onebase.module.bpm.enums.definition.*;
import com.cmsr.onebase.module.bpm.enums.task.BpmCommentTypeEnum;
import com.cmsr.onebase.module.bpm.enums.task.BpmReasonEnum;
import com.cmsr.onebase.module.bpm.enums.task.BpmTaskSignTypeEnum;
...
import com.cmsr.onebase.module.bpm.service.definition.BpmFormService;
import com.cmsr.onebase.module.bpm.service.definition.BpmModelService;
...
import com.cmsr.onebase.module.bpm.service.message.dto.BpmMessageSendWhenTaskTimeoutReqDTO;
...
import static com.cmsr.onebase.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_RETURN_FLAG;
import static com.cmsr.onebase.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_SKIP_START_USER_NODE;
import static com.cmsr.onebase.module.bpm.framework.flowable.core.util.BpmnModelUtils.*;
...
public class BpmTaskServiceImpl implements BpmTaskService {
    ...
    public void moveTaskToEnd(String processInstanceId, String reason) {
        ...
        // TODO 开发者：目前发现并行分支情况下，会存在这个情况，后续看看有没更好的方案；
    ...
    public void processTaskAssigned(Task task) {
        ...
        TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronization() {
            ...
            public void afterCompletion(int transactionStatus) {
                ...
                // 自动去重，通过自动审批的方式 TODO @开发者 驳回的情况得考虑一下；@lesan：驳回后，又自动审批么？
                ...
                // TODO 开发者：【优化】未来有没更好的判断方式？！另外，还要考虑清理机制。就是说，下次处理了之后，就移除这个标识
