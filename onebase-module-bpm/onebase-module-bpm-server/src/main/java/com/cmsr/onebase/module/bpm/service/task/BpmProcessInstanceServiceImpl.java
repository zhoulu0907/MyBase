package com.cmsr.onebase.module.bpm.service.task;
...
import com.cmsr.onebase.framework.common.util.object.PageUtils;
import com.cmsr.onebase.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import com.cmsr.onebase.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.cmsr.onebase.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.cmsr.onebase.module.bpm.controller.admin.task.vo.instance.*;
import com.cmsr.onebase.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.cmsr.onebase.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.cmsr.onebase.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.cmsr.onebase.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.cmsr.onebase.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.cmsr.onebase.module.bpm.enums.ErrorCodeConstants;
import com.cmsr.onebase.module.bpm.enums.definition.BpmModelTypeEnum;
import com.cmsr.onebase.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.cmsr.onebase.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.cmsr.onebase.module.bpm.enums.task.BpmReasonEnum;
import com.cmsr.onebase.module.bpm.enums.task.BpmTaskStatusEnum;
import com.cmsr.onebase.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.cmsr.onebase.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import com.cmsr.onebase.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import com.cmsr.onebase.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.cmsr.onebase.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
...
import com.cmsr.onebase.module.bpm.service.message.BpmMessageService;
...
import static com.cmsr.onebase.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.cmsr.onebase.module.bpm.enums.ErrorCodeConstants.*;
import static com.cmsr.onebase.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.cmsr.onebase.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    private List<ActivityNode> getSimulateApproveNodeList(Long startUserId, BpmnModel bpmnModel,
                                                          ...
                                                          Map<String, Object> processVariables,
                                                          List<HistoricActivityInstance> activities) {
        // TODO @开发者：【可优化】在驳回场景下，未来的预测准确性不高。原因是，驳回后，HistoricActivityInstance
