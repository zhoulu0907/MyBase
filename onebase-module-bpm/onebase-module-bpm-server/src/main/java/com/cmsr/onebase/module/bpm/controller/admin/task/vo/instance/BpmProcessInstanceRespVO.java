package com.cmsr.onebase.module.bpm.controller.admin.task.vo.instance;
...
public class BpmProcessInstanceRespVO {
    ...
    public static class Task {
        ...
        @Schema(description = "任务名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "onebase")
        private String name;
